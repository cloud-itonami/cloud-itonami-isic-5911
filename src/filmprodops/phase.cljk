(ns filmprodops.phase
  "Phase 0->3 staged rollout for the ISIC-5911 motion-picture/video/
  TV-programme-production operations-coordination actor.

    Phase 0  read-only            -- no writes, still governor-gated.
    Phase 1  assisted-logging     -- shoot-day/scene/take record logging
...
(defn verdict->disposition
  "Map a FilmProductionGovernor verdict to a base disposition before the
  phase gate."
  [verdict]
