# Operator Quickstart — Motion Picture, Video and Television Programme Production Activities

Shortest path from clone to a verified local dry-run for **ISIC 5911** (`cloud-itonami-isic-5911`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-5911.git
cd cloud-itonami-isic-5911
```
...
- Blueprint governor key: `film-production-governor`
- Likely source path: `filmprodops.governor.cljc`
